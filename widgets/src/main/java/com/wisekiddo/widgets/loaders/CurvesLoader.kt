...
class CurvesLoader : LinearLayout, LoaderContract {
    ...
    override fun initAttributes(attrs: AttributeSet) {
        ...
        this.outermostCurveRadius =
            typedArray.getDimensionPixelSize(R.styleable.CurvesLoader_curves_outermostCurveRadius, 100)

        this.curveWidth = typedArray.getDimensionPixelSize(R.styleable.CurvesLoader_curves_curveWidth, 10)
        this.distanceBetweenCurves =
            typedArray.getDimensionPixelSize(R.styleable.CurvesLoader_curves_distanceBetweenCurves, 10)
